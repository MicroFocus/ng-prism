	...
	function ToggleRepeatDirective(RepeatAsCodeService, $compile) {
	    return {
	        ...
	        compile: function (tElement, tAttrs) {
	            ...
	            var codeElement = angular_1.element("<div class=\"prism-toggleable-code\"></div>").append(code);
