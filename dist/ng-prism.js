...
/***/ function(module, exports, __webpack_require__) {
	...
	var toggle_show_directive_1 = __webpack_require__(8);
	...
	angular_1.module('ng-prism', [])
	    ...
	    .directive('toggleShow', toggle_show_directive_1.default)
	    ...
	    function () {
	        return {
	            ...
	            compile: function (tElement, attr) {
	                var codeBlock = tElement.next();
	                if (codeBlock.prop('tagName') === 'PRE') {
	                    tElement.after(angular_1.element(HIDE_CODE));
	                }
	                else {
...
/***/ function(module, exports) {
	...
	var path = 'templates/show-code.template.html';
	    ...
	    function (RepeatAsCodeService) {
	        return {
	            ...
	            compile: function (tElement, attr) {
	                ...
	                var showHide = angular_1.element("<toggle-show></toggle-show>");
