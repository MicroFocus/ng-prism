...
/***/ function(module, exports, __webpack_require__) {
	...
	angular_1.module('ng-prism', [])
	    ...
	    .factory('InsertElementService', insert_element_service_1.default)
...
/***/ function(module, exports, __webpack_require__) {
	...
	function InsertElementService() {
	    return function (element, defaultPrevSibling, defaultTagName, attrs) {
	        if (attrs.prismInsertId) {
	            var parentElement = document.getElementById(attrs.prismInsertId);
	            parentElement.insertBefore(element[0], parentElement.firstElementChild);
	        }
	        else {
	            var parentElement = angular_1.element("<" + defaultTagName + "></" + defaultTagName + ">").append(element);
...
/***/ function(module, exports) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = ['InsertElementService', 'RepeatAsCodeService', ToggleRepeatDirective];
	function ToggleRepeatDirective(InsertElementService, RepeatAsCodeService) {
	    return {
	        priority: 1000,
	        restrict: 'A',
	        compile: function (element, attr) {
	            ...
	            var code = RepeatAsCodeService(element, attr.toggleRepeatCode);
