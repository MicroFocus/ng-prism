	    ...
	    return {
	        ...
	        compile: function (tElement, tAttrs) {
	            ...
	            if (tAttrs.toggleableCodeId) {
	                var toggleableCode = document.getElementById(tAttrs.toggleableCodeId);
